...
import {
  ...
  ClipboardList, GitBranch, Star, TrendingUp, Globe,
} from "lucide-react";
    ...
    <div className="flex h-full flex-col sidebar-bg">
      ...
      <div className="flex h-16 items-center justify-between px-6" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="flex items-center gap-3">
          ...
          <span className="font-serif font-semibold text-lg text-white">Grant2Fund'n</span>
        </div>
        {onClose && (
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between h-14 px-4 md:hidden"
        style={{ background: "#0B1D35", borderBottom: "1px solid rgba(255,255,255,0.08)", position: "fixed", top: 0, left: 0, right: 0, zIndex: 40 }}>
